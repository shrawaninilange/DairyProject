...
<body>
    ...
    <div class="con1">
        <div class="con2">
            ...
            <div>   <p class="in">The Natural Sweetness of Cow Milk</p> <a href="javascript:void(0);" onclick="toggleContent('more1')" class="readmore">Read More</a></div>
        ...
        <div class="con2">
           ...
           <div>   <p class="in">The Rich Creaminess of Buffalo Milk</p>  <a href="javascript:void(0);" onclick="toggleContent('more2')" class="readmore">Read More</a></div>
        ...
        <div class="con2">
            ...
            <div> <p class="in">Rich in Nutrients, Low in Fat</p> <a href="javascript:void(0);" onclick="toggleContent('more3')" class="readmore">Read More</a></div>
