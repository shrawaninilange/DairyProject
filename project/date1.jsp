...
%>
 ...
 <div class="date">
    <div  >
        <form action="date1.jsp"  method="get">
    ...
    <div>
        <form action="date1.jsp" method="get">
            ...
            <button type="submit" class="today">Today's Sell</button>
        </form>
    </div>
    
      
 </div>
 <div style="margin-bottom: 30px;" class="list"><h2 align="center" class="lih2"><font><strong> Analysis Of Data By Date wise</strong></font></h2>
 </div>
...
String query = "SELECT * FROM lassibutter WHERE 1=1"; // Start with 1=1 for easy appending of conditions

    

if (startDate != null && endDate != null && !startDate.isEmpty() && !endDate.isEmpty()) {
    // Add date conditions to the query
    query += " AND currdate BETWEEN '" + startDate + "' AND '" + endDate + "'";
}
else{
    if (today != null && today.equals("true")) {
        // If "Today's Sell" button was clicked, set the date range to today
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        String currentDate = sdf.format(new Date());
        query += " AND currdate = '" + currentDate + "'";
    }
}
