...
%>
 ...
 <div>
     <form action="filterdbforlassi.jsp" method="get">
         ...
         <label for="add">
            ...
            <select name="typee" class="ibbb" class="ib">
                ...
                <option value="butterMilkHalf"> Half lt butterMilk  </option>
                <option value="lassi">Lassi </option>
                <option value="lassiHalf">Half Lassi </option>
                 
                <option value="MasalaButtermilk">Masala ButterMilk </option>
                <option value="MasalaButtermilkHalf">Half lt Masala ButterMilk  </option>
 ...
 <div style="margin-bottom: 30px;" class="list"><h2 align="center" class="lih2"><font><strong> Analysis Of Data By  Type Of Product Sold</strong></font></h2>
 </div>
 ...
 try{ 
     ...
     String query = "SELECT * FROM lassibutter";
